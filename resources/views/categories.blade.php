                        ...
                        <div class="card-body card-block">
                            <form action="{{route ('categories')}}" method="post" enctype="multipart/form-data" class="form-horizontal">
                                <div class="row form-group">
                                    <div class="col col-md-3"><label for="text-input" class=" form-control-label">Input Categori</label></div>
                                    <div class="col-12 col-md-9"><input type="text" name="name" id="categories" placeholder="Input Categories"></div>
                                    @csrf
                                </div>
